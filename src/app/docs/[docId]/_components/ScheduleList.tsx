          ...
          (
            <ListItem key = {index} sx={{ height: '40px', borderRadius : '8px'}} className='flex mb-3'>
              ...
              <div className='hover:bg-slate-300 rounded-2xl mr-1' onClick={() => {swap(index)}}>
                {(index != 0) && <svg fill="#88c7f7" height="24" width="24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" xmlSpace="preserve">
                  <g>
              ...
              <div className='hover:bg-slate-300 rounded-2xl mr-1' onClick={() => {swap(index+1)}}>
                {(index != location.length - 1) ? (<svg fill="#88c7f7" height="24" width="24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" xmlSpace="preserve">
                  <g>
